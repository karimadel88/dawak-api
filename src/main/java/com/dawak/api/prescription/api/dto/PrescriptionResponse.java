...
public record PrescriptionResponse(
        UUID id, UUID medicinePackageId, String originalFilename, String contentType, long fileSize, String checksumSha256,
    ...
    public static PrescriptionResponse from(Prescription value) {
        return new PrescriptionResponse(value.getId(), value.getMedicinePackageId(), value.getOriginalFilename(),
